...
{block content}
	...
	<h2>Success!</h2>
	<p>Thanks for checking in {if $Checkin->Project}to {projectLink $Checkin->Project}{/if} @ Code for Philly!</p>
	<h3>Things to do next:</h3>
	<ul>
		{if $Checkin->Project}
			<li><a href="/projects/{$Checkin->Project->Handle}">Post an update to your project</a></li>
		{else}
