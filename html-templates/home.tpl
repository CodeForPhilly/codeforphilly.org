					...
					<div class="col-lg-8">
						<div class="modal-body">
							<?php
								...
								echo "<h2 class='text-uppercase'>".$object->Title."</h2>";
							?>
							<img class="img-fluid d-block mx-auto img-modal" src="/img/portfolio/{$image}" alt="" />
								...
								<?php
									...
									echo $parsedown->text($object->README);
								?>
								</div>
								<a href="/projects/<?php echo $object->Handle ?>" target="_blank" class="btn btn-primary">Project Page</a>
								<a href="<?php echo $object->UsersUrl ?>" target="_blank" class="btn btn-primary">Project Website</a>
								<a href="<?php echo $object->DevelopersUrl ?>" target="_blank" class="btn btn-primary">Github</a>
								<div class="modal-join-slack">
									<p>Want to join this project? Introduce yourself in the #<?php echo $object->ChatChannel ?> Slack channel.</p>
									<a href="/chat?channel=<?php echo $object->ChatChannel ?>" target="_blank" class="btn btn-primary">Join Slack</a>
								</div>
						  	</div>
					  	</div>
				  	</div>
