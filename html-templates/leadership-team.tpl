...
{block content}
    ...
    <h2>Meet The Team</h2>
        ...
        <div><img src="chriscirc.png" alt="chris" width="150" height="150" align="left" />
          <p>Chris Alfano | Brigade Captain</p>
          <p>Chris oversees the development of CfP&rsquo;s strategic plan, leadership team, and technology infrastructure.</p>
          <p>@themightychris | <a href="mailto:chris@codeforphilly.org">chris@codeforphilly.org</a></p>
        </div>
        
        <div><img src="dawncirc.png" alt="dawn" width="150" height="150" align="left" />
          <p> Dawn McDougall | Executive Director</p>
          <p>As Executive Director, Dawn maintains and builds the Code for Philly community, its leadership team, and organizational relationships. </p>
          Dawn is a civic hacker by way of her love of cities (particularly Philly) and fixation on urban government/civic engagement. </p>
          <p>@de_mcdougs | <a href="mailto:dawn@codeforphilly.org">dawn@codeforphilly.org</a></p>
        </div>
        
        <div><img src="bencirc.png" alt="brn" width="150" height="150" align="left" /> 
          <p>Ben Novack | Projects Lead</p>
          <p>Ben helps CfP projects succeed, working with civic hackers and partner organizations to coordinate efforts and resources.</p>
          <p>@titlecharacter | <a href="mailto:ben@codeforphilly.org">ben@codeforphilly.org</a></p>
        </div>
        
        <div><img src="corey-circ.png" alt="corey" width="150" height="150" align="left" />
          <p> Corey Acri | Collaborations Lead</p>
          <p>Corey works on various elements of CfP's operations strategy, member experience and external partnerships.</p>
          <p>Corey is the co-creator of <a href="http://www.cyclephilly.org/">CyclePhilly</a>, a digital product development consultant and loves all things bike.</p>
          <p>@AcriCAA | <a href="mailto:corey@codeforphilly.org">corey@codeforphilly.org</a></p>
        </div>
