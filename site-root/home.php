...
echo "passing through file:".__FILE__ . " num args - " . var_dump($argc) . "- values" .var_dump($argv) ;
...
//debug $_POST snippet:
#echo"DEBUG"; print_r($_POST); echo"DEBUG";


#mysqli_debug("d:t:o,/client.trace");


//print_r(array_values($pageData));
#echo "TEST . $pageData[0] . TEST ";
// render data against home template


RequestHandler::respond('home', $pageData);
RequestHandler::respond('sponsor', $pageData);
